...
- The briefing may include SIGNALS (insider trades, Wikipedia attention, GitHub developer activity, Coinbase app rank). Use them to decide what to research and to adjust your probability, never as a catalyst on their own: an attention spike usually means news already happened, so find out what it was.
